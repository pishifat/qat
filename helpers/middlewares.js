...
function discordEmbeds(req, res, next) {
    ...
    const routes = [
        ...
        { path: 'contentreview', title: 'Content Review' },
        { path: 'contentreview/:id', title: 'Content Review' },
        { path: 'discussionvote', title: 'Discussion Votes' },
        { path: 'discussionvote/:id', title: 'Discussion Vote' },
