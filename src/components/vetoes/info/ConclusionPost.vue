<template>
    <div id="conclusion" class="collapse card card-body my-2 small pre-line">
        ...
        <br>
        <span>After an anonymous vote, it has been decided that the veto will be {{ majorityUphold ? 'upheld' : 'dismissed' }}. The following are reasons why Beatmap Nominators {{ majorityUphold ? 'agree' : 'disagree' }} with the veto:</span>
        <br>
        <br>
