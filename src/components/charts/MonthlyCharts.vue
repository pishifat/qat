<template>
    <div>
        <div class="ml-2">
            ...
            <p class="pt-3">
                <b>Monthly Charts</b> are a way for BNs to collectively curate their nominations. Every BN can pick <b>one map every month</b> as the "best" map they've promoted to the Ranked section. Any other BN can upvote or downvote a map on the list.
            </p>
