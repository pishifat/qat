        ...
        <div v-if="selectedEvaluation" class="container">
            ...
            <div v-else>
                ...
                <template v-if="selectedEvaluation.active">
                    <hr />
                    <evaluation-input v-if="selectedEvaluation.isApplication || (!selectedEvaluation.user.evaluatorModes.includes(selectedEvaluation.mode) && !selectedEvaluation.user.modes.includes('none') && !loggedInUser.isNatLeader)" />
