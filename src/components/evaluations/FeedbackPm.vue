...
<div>
    <div v-if="discussApp">
        <div v-if="discussApp.consensus == 'pass'" id="forumPmBox" class="copy-paste collapse">
            ...
            <samp class="small">Following a positive evaluation of your BN application for the [i]{{discussApp.mode}}[/i] game mode, you've been invited to join the Beatmap Nominators. Congratulations!</samp><br><br>
        ...
        <div v-else id="forumPmBox" class="copy-paste collapse">
            <samp class="small">Hello!</samp><br><br>
            <samp class="small">Following an evaluation of your BN application for the [i]{{discussApp.mode}}[/i] game mode, we've decided not to admit you into the Beatmap Nominators.</samp><br><br>
            <samp class="small">Your test results can be found here: http://bn.mappersguild.com/testresults</samp><br><br>
    ...
    <div v-else-if="discussRound">
        <div v-if="discussRound.consensus == 'pass'" id="currentBnForumPmBox" class="copy-paste collapse">
            ...
            <span v-if="discussRound.bn.probation.indexOf(discussRound.mode) >= 0">
                <samp class="small">Following a positive evaluation of your work as a BN for the [i]{{discussRound.mode}}[/i] game mode, we've decided to conclude your probation period and promote you to a full Beatmap Nominator. Congratulations!</samp><br><br>
            ...
            <span v-else-if="discussRound.isLowActivity">
                <samp class="small">We've noticed that your nomination activity for the [i]{{discussRound.mode}}[/i] game mode is too low to effectively evaluate your work as a Beatmap Nominator. That said, we won't place you on probation, however we will follow up on your nomination activity one month from now in hopes that it improves. If it does not, you will likely be removed from the Beatmap Nominators for this game mode.</samp><br><br>
            </span>
            <span v-else>
        ...
        <div v-else-if="discussRound.consensus == 'extend'" id="currentBnForumPmBox" class="copy-paste collapse">
            <samp class="small">Hello!</samp><br><br>
            <span v-if="discussRound.bn.probation.indexOf(discussRound.mode) >= 0">
                <samp class="small">After reviewing your work as a BN for the [i]{{discussRound.mode}}[/i] game mode, we have decided to [b]extend your probation period[/b].</samp><br><br>
        ...
        <div v-else id="currentBnForumPmBox" class="copy-paste collapse">
            <samp class="small">Hello!</samp><br><br>
            <samp class="small">After reviewing your work as a BN for the [i]{{discussRound.mode}}[/i] game mode, we have decided to [b]remove you from the Beatmap Nominators[/b].</samp><br><br>
