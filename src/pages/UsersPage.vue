...
<div class="row">
    <div class="col-md-12">
        ...
        <section v-if="isNat" class="segment segment-solid my-1 mx-4">
            ...
            <div class="my-2">
                <button class="btn btn-sm btn-nat minw-200 my-1" @click="findPotentialNatInfo()"
                    data-toggle="tooltip" data-placement="right" title="Finds info on prospective NAT members">Load potential NAT info
                </button>
                <div v-if="potentialNatInfo.length">
                    <div v-for="user in potentialNatInfo" :key="user.osuId" class="small min-spacing my-2">
                        ...
                        <p class="ml-2 min-spacing">
                            <a data-toggle="collapse" :href="'#evaluations' + user.osuId" @click.prevent>Show app evals ({{user.evaluatedApps.length}}) <i class="fas fa-angle-down"></i></a>
                        </p>
                        <div class="collapse ml-4" :id="'evaluations' + user.osuId">
