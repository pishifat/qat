...
function userIsNatEvaluatorForMode(user, mode) {
...
function isNatEvaluation(evaluation) {
...
module.exports = { isNatEvaluation, userIsNatEvaluatorForMode, NAT_CONSENSUS, BN_CONSENSUS };
