...
const userSchema = new mongoose.Schema({
    ...
    customGenrePreferences: [{ type: String }],
    ...
    customLanguagePreferences: [{ type: String }],
    ...
    customMapPreferences: [{ type: String }],
    customDetailPreferences: [{ type: String }],
    customMapperPreferences: [{ type: String }],
...
class UserService extends mongoose.Model {
            ...
            return await query.collation({ locale: 'en' }).sort({
                ...
                users: {
                    $push: {
                        ...
                        customGenrePreferences: '$customGenrePreferences',
                        languagePreferences: '$languagePreferences',
                        languageNegativePreferences: '$languageNegativePreferences',
                        customLanguagePreferences: '$customLanguagePreferences',
                        ...
                        customMapPreferences: '$customMapPreferences',
                        customDetailPreferences: '$customDetailPreferences',
                        customMapperPreferences: '$customMapperPreferences',
                        history: '$history',
                    },
                },
            });
    ...
    static async getAssignedTrialNat (mode, excludeOsuIds, sampleSize) {
        ...
        let users = await this.queryAssignmentUsers(mode, excludeOsuIds, sampleSize, false, false);

        if (!users.length) {
            users = await this.queryAssignmentUsers(mode, excludeOsuIds, sampleSize, false, true); // fixes edge case where there are no bag users when trial nat period begins
        }
